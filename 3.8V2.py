...
class Activation_Net(nn.Module):
    def __init__(self, input_size, hidden_size, num_classes):
        ...
        self.layer2 = nn.Sequential(nn.Linear(hidden_size, 20), nn.ReLU(True))
        self.layer3 = nn.Sequential(nn.Linear(20, num_classes))
        # nn.Sequential()等价于分别进行两步
...
model = Activation_Net(input_size, hidden_size, num_classes).to(device)
